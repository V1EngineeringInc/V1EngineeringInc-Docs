...
* The core is very order of operations oriented so take these steps in order.
...
* You can line them up and give them a tap with the ratched handle and they should pop into place.
...
!!! Caution
    Ratchets are dangerous here. We only need 7in/lbs or so. It is next to nothing. Loose is better then too tight. Remember that for all these steps.
...
* Paying attention to the direction of the bolt heads for Z clearance assemble all 4 sets.
...
* For each Core Clamp printed part you will also need 2 bolts, nuts, and bearings.
* You are going to want to pay attention to which direction the part is facing and the bolt head direction as well.
* Use the pictures to compare.
...
* You will need the brass T8 Lead Screw Nut and two M3 x 10 Screws
